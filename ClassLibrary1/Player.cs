   ...
   public class Player : LivingCreature
    {
        ...
        public string ToXmlString()
        {
            ...
            // Create the "PlayerQuests" child nose to hold each player quest node
            ...
            return playerData.InnerXml; // The XML document, as a string, so we can save the data to dick
        }
        ...
        public void RemoveItemFromInventory(Item itemToRemove, int quantity = 1)
        {
            ...
            else
            {
                ...
                // Don't alllow negative quantities. We might want to raise an error for this situation
                if(item.Quantity < 0)
                {
                    item.Quantity = 0;
                }
        ...
        public void UseWeapon(Weapon weapon)
        {
            ...
            if (_currentMonster.CurrentHitPoints <= 0)
            {
                ...
                // Add items to the lootedItems list, comparing random number to the drop percentage
        ...
        public void UsePotion(HealingPotion potion)
        {
            ...
            // CurrentHitPoints cannot exceed playuer's MaximumHitPoints
